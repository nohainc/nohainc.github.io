...
EXPECTED_IMPLEMENTATIONS_DESCRIPTION = (
    "Compare Nano Markup implementations for Python, Go, JavaScript, TypeScript, Dart, Java, .NET, C, C++, Rust, Swift, and PowerShell."
)
EXPECTED_IMPLEMENTATION_LINKS = {
    ...
    "https://github.com/nohainc/nanomarkup.powershell",
    "https://github.com/nohainc/nanomarkup.powershell/releases/tag/v1.0.0",
}
EXPECTED_SITE_PAGES = (
    "index.html",
    "specification.html",
